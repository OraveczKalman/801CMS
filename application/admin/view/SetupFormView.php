<div class="card shadow mb-12">
    ...
    <form id="setupForm" role="form" method="post" action="Setup">
        <div class="card-body">
            <h7><?php print $setupLabels->labels->galleryThumbnail; ?>:</h7>
            ...
            <h7><?php print $setupLabels->labels->galleryThumbnail; ?>:</h7>
            <div class="form-group">
                <label><?php print $setupLabels->labels->widthLabel; ?>:</label>
                <input class="form-control" type="text" value="<?php if (isset($setupData)) { print $setupData -> galleryThumb -> width; } ?>" maxlength="4" name="setup[galleryThumb][width]" id="galleryThumbWidth" />
            </div>
            <div class="form-group">
                <label for="galleryThumbHeight"><?php print $setupLabels->labels->heightLabel; ?>:</label>
            ...
            <h7><?php print $setupLabels->labels->galleryPicture; ?>:</h7>
            <div class="form-group">
            ...
            <h7><?php print $setupLabels->labels->galleryHeader; ?>:</h7>
            <div class="form-group">
            ...
            <h7><?php print $setupLabels->labels->articleThumbnail; ?>:</h7>
            <div class="form-group">
            ...
            <label><?php print $setupLabels->labels->articlePicture; ?>:</label>
            <div class="form-group">
            ...
            <h7><?php print $setupLabels->labels->articleCover; ?>:</h7>
            <div class="form-group">
            ...
            <h7><?php print $setupLabels->labels->youtubeVideo; ?>:</h7>
            <div class="form-group">
            ...
            <h7><?php print $setupLabels->labels->video; ?>:</h7>
            <div class="form-group">
