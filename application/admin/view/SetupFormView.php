            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" id="messageWallType" name="setup[messageWallType]">
                        <option value="0" <?php if ($setupData -> messageWallType == 0) { print 'selected'; } ?>><?php print $setupLabels->labels->chooseLabel; ?></option>
                        <option value="1" <?php if ($setupData -> messageWallType == 1) { print 'selected'; } ?>><?php print $setupLabels->labels->typeLabel1; ?></option>
                        <option value="2" <?php if ($setupData -> messageWallType == 2) { print 'selected'; } ?>><?php print $setupLabels->labels->typeLabel2; ?></option>
                    </select>
                </div>
            </div>
