...
?>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <input type="hidden" id="descriptionState<?php print $actCount; ?>" name="descriptions[<?php print $actCount; ?>][descriptionState]" value="<?php if (empty($descriptionArray)) { print 1; } else { print 0; } ?>">
        </div>
    </div>
