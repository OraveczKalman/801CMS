...
?>
            <li class="nav-item">
                <a class="nav-link <?php if ($i==0) { print "active"; } ?>" id="langItem<?php print $i; ?>" href="#lang<?php print $i; ?>" role="tab"><?php print $languageList[$i]["Description"]; ?></a>
            </li>
<?php
        }
?>
...
<?php
        for ($i=0; $i<=count($languageList)-1; $i++) {            
?>
            <div class="panel-group" id="lang<?php print $i; ?>">
